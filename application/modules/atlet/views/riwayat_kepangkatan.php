...
<?php 
    $columns = array('guru_kepangkatan_label');
    $this->crud->set_url('guru');
    $this->crud->set_ajax_url('guru/riwayatkepangkatan');
    $this->crud->set_modal_url('guru/modal/riwayat_kepangkatan');
    $this->crud->set_target_id('guru_kepangkatan_id');
