...
<?php 
    $columns = array('guru_permasalahan_label');
    $this->crud->set_url('guru');
    $this->crud->set_ajax_url('guru/riwayatpermasalahan');
    $this->crud->set_modal_url('guru/modal/riwayat_permasalahan');
    $this->crud->set_target_id('guru_permasalahan_id');
