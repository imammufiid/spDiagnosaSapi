...
<?php 
    $columns = array('guru_jabatan_label');
    $this->crud->set_url('guru');
    $this->crud->set_ajax_url('guru/riwayatjabatan');
    $this->crud->set_modal_url('guru/modal/riwayat_jabatan');
    $this->crud->set_target_id('guru_jabatan_id');
