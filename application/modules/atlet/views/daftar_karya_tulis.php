...
<?php 
    $columns = array('guru_karya_label');
    $this->crud->set_url('guru');
    $this->crud->set_ajax_url('guru/daftarkaryatulis');
    $this->crud->set_modal_url('guru/modal/daftar_karya_tulis');
    $this->crud->set_target_id('guru_karya_id');
