...
<?php 
    $columns = array('guru_penghargaan_label');
    $this->crud->set_url('guru');
    $this->crud->set_ajax_url('guru/daftarpenghargaan');
    $this->crud->set_modal_url('guru/modal/daftar_penghargaan');
    $this->crud->set_target_id('guru_penghargaan_id');
