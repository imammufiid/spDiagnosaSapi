	...
	<div class="kt-portlet__head">
		<div class="kt-portlet__head-label">
			<h3 class="kt-portlet__head-title">
				Jumlah Guru yang memiliki sertifikasi maupun yang belum
			</h3>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#tabel-data').dataTable({
			ajax:{url:"<?php echo base_url('guru/fetch') ?>",dataSrc:"data","type": "POST"},
			processing: true,
        	serverSide: true,
			columns: [
				{data: null, render: function(data, row, columns, meta){
					return '<a href="<?php echo(base_url('guru/show').'/') ?>'+data.guru_id+'">'+data.guru_nip+'</a>';
				}},
				{data: 'guru_nama'},
				{data: 'guru_tptg_lahir', searchable: false},
				{data: 'guru_alamat'},
				{data: 'schools_name'},
				{data: 'sertifikasi_label'},
			],
		});
	...
	function dt_add(t) {
		$.get('<?php echo base_url('guru/modal/add') ?>').done(function(data) {
