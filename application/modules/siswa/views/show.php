...
<ul class="nav nav-pills" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="domisili"><i class="fa fa-book-reader"></i>Domisili</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="riwayat_pendidikan"><i class="fa fa-book-reader"></i>Riwayat Pendidikan</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="penghasilan_orangtua"><i class="fa fa-book-reader"></i>Penghasilan Orang Tua</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="daftar_penghargaan"><i class="fa fa-book-reader"></i>Daftar Penghargaan</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="daftar_beasiswa"><i class="fa fa-book-reader"></i>Daftar Beasiswa</a>
    </li>
</ul>
</div>
...
<script type="text/javascript">
    $('.nav-pills .nav-link').click(function(event) {
        ...
        $.get('<?php echo base_url('siswa/modal/') ?>' + href, {'siswa_nisn':'<?php echo $this->uri->segment(3) ?>'}).done(function(data) {
