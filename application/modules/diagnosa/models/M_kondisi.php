...
{
  var $table = 'kondisi'; //nama tabel dari database
	var $column_order = ['id', 'kondisi', 'bobot']; //field yang ada di table user
	var $column_search = ['id', 'kondisi', 'bobot']; //field yang diizin untuk pencarian 
