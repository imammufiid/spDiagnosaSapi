...
<?php 
    $columns = array('guru_pembinaan_label');
    $this->crud->set_url('guru');
    $this->crud->set_ajax_url('guru/riwayatpembinaan');
    $this->crud->set_modal_url('guru/modal/riwayat_pembinaan');
    $this->crud->set_target_id('guru_pembinaan_id');
