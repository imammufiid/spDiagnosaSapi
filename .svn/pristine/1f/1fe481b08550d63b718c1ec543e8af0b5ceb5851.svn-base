...
<?php 
    $columns = array('pendidikan_label', 'guru_pendidikan_label');
    $this->crud->set_url('guru');
    $this->crud->set_ajax_url('guru/pendidikan');
    $this->crud->set_modal_url('guru/modal/riwayat_pendidikan');
    $this->crud->set_target_id('guru_pendidikan_id');
