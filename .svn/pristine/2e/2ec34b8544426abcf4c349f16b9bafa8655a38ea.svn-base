...
<?php 
    $columns = array('guru_diklat_label');
    $this->crud->set_url('guru');
    $this->crud->set_ajax_url('guru/riwayatdiklat');
    $this->crud->set_modal_url('guru/modal/riwayat_diklat');
    $this->crud->set_target_id('guru_diklat_id');
